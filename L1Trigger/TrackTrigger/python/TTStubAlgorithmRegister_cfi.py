...
TTStubAlgorithm_official_Phase2TrackerDigi_ = cms.ESProducer("TTStubAlgorithm_official_Phase2TrackerDigi_",
   ...
   BarrelCut = cms.vdouble( 0, 2.0, 2.0, 3, 4.5, 5.5, 6.5), #Use 0 as dummy to have direct access using DetId to the correct element 
   ...
   TiltedBarrelCutSet = cms.VPSet(
       ...
       cms.PSet( TiltedCut = cms.vdouble( 0, 2, 2, 2, 2, 2, 2, 1.5, 1.5, 1.5, 1.5, 1.5, 1.5) ),     #TBPS L1 rings
       cms.PSet( TiltedCut = cms.vdouble( 0, 2.5, 2.5, 2.5, 2, 2, 2, 2, 2.5, 2, 2, 2, 2) ),         #TBPS L2 rings
       cms.PSet( TiltedCut = cms.vdouble( 0, 3, 3, 3, 3, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5) ), #TBPS L3 rings
    ),
