...
//	   std::cout << " E center " << ecalhits[centerId].e << " phi " << ecalhits[centerId].phi << " eta " << ecalhits[centerId].eta <<  std::endl ;
	  ...
	  for(int k=0; k<nHits; k++)
	    {
	      if ( k != centerId && fabs(ecalhits[centerId].eta-ecalhits[k].eta) < 0.06 && fabs(ecalhits[centerId].phi-ecalhits[k].phi) < 0.1 )
		{
//	  std::cout << " E to add " << ecalhits[k].e << " phi " << ecalhits[k].phi << " eta " << ecalhits[k].eta <<  std::endl ;
	  ...
	  for(int k=0; k<nHitsHCAL; k++)
	    {
	      if ( fabs(ecalhits[centerId].eta-hcalhits[k].eta) < 0.06 && fabs(ecalhits[centerId].phi-hcalhits[k].phi) < 0.1 )
		{
