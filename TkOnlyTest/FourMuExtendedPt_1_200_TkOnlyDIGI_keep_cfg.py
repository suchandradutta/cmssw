...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:FourMuExtendedPt_1_200_GEN_SIM.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_DIGI_L1_L1TrackTrigger_DIGI2RAW_HLT.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.tkonlyDigitization_step)
