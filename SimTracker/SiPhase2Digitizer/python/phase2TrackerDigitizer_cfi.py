...
#D.B.:the noise should be a function of strip capacitance, roughly: ReadoutNoiseInElec=500+(64*Cdet[pF]) ~= 500+(64*1.5[cm])
      ...
      0.999, 0.999 ),#Efficiencies kept as Side2Disk1,Side1Disk1 and so on
      CellsToKill = cms.VPSet(),
      HitDetectionMode = cms.int32(0),  # (0/1/2/3/4 => SquareWindow/SampledMode/LachedMode/SampledOrLachedMode/HIPFindingMode)
      PulseShapeParameters = cms.vdouble(17.709809, 16.043703, 99.999857, 40.571650, 2.0, 1.2459094),
#      PulseShapeParameters = cms.vdouble(-5.0, 16.043703, 99.999857, 40.571650, 2.0, 1.2459094),
        CBCDeadTime = cms.double(0.0) # (2.7 ns deadtime in lached mode)
    )
)
